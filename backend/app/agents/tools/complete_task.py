...
def complete_task(user_id: str, task_id: Optional[int] = None, task_title: Optional[str] = None) -> Dict[str, Any]:
    """
    MCP tool to mark a task as complete.

    Args:
        user_id: The ID of the user who owns the task
        task_id: The ID of the task to mark as complete (optional if task_title provided)
        task_title: The title of the task to mark as complete (optional if task_id provided)
